...
const ENGINEERING_STANDUP = `[Engineering Standup, May 7]
...
const PRODUCT_PLANNING = `[Q3 Product Planning, May 6]
...
const INCIDENT_POSTMORTEM = `[Incident Postmortem — Outage May 5, 14:00 UTC]
...
const CUSTOMER_FEEDBACK = `[Customer Success Sync, May 4]
...
export const SAMPLE_SCENARIOS: SampleScenario[] = [
  {
    ...
    description: "Stripe timeout, OAuth migration, onboarding emails",
    emoji: "🛠",
    transcript: ENGINEERING_STANDUP,
  },
  {
    id: "planning",
    label: "Q3 product planning",
    description: "Analytics rewrite, SSO, mobile bug",
    emoji: "🗺",
    transcript: PRODUCT_PLANNING,
  },
  {
    id: "incident",
    label: "Incident postmortem",
    description: "Payment outage, alerting, runbook",
    emoji: "🚨",
    transcript: INCIDENT_POSTMORTEM,
  },
  {
    id: "customer",
    label: "Customer feedback sync",
    description: "CSV export, dashboard perf, SSO",
    emoji: "💬",
    transcript: CUSTOMER_FEEDBACK,
  },
];

// Default sample for backwards compat (used by ?sample=1 deep link)
export const SAMPLE_TRANSCRIPT = ENGINEERING_STANDUP;
